...
import static de.aittr.g_38_jp_shop.constans.Constans.Constants.*;
...
public class ProductRepositoryTemp implements ProductRepository {
    ...
    private Connection getConnection() {
        try {
            // Следующая строка загружает класс драйвера в память,
            // чтобы он был доступен во время выполнения
